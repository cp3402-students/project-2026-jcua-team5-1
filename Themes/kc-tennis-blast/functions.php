...
function kc_tennis_blast_setup() {
	/*
		...
		* If you're building a theme based on kc-tennis-blast, use a find and replace
		* to change 'kc-tennis-blast' to the name of your theme in all the template files.
		*/
	...
	register_nav_menus(
		array(
			'menu-1' => esc_html__( 'Primary', 'kc-tennis-blast' ),
		)
	);
 ...
 */
function kc_tennis_blast_content_width() {
	$GLOBALS['content_width'] = apply_filters( 'kc_tennis_blast_content_width', 640 );
}
add_action( 'after_setup_theme', 'kc_tennis_blast_content_width', 0 );
 ...
 */
function kc_tennis_blast_widgets_init() {
	register_sidebar(
		array(
			'name'          => esc_html__( 'Sidebar', 'kc-tennis-blast' ),
			'id'            => 'sidebar-1',
			'description'   => esc_html__( 'Add widgets here.', 'kc-tennis-blast' ),
...
add_action( 'widgets_init', 'kc_tennis_blast_widgets_init' );
